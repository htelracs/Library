...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loggin.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        loggin.setForeground(new java.awt.Color(204, 153, 0));
        loggin.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        loggin.setText("LOGIN");
        jPanel1.add(loggin, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 200, 40));
        ...
        jPanel1.add(usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 80, 30));
        ...
        jPanel1.add(perfil, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 280, 60, 30));

        lista.setBackground(new java.awt.Color(153, 204, 255));
        ...
        jPanel1.add(lista, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, 290, 30));
        ...
        jPanel1.add(textusua, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 290, 30));

        jSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 290, 10));

        correo.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        correo.setForeground(new java.awt.Color(255, 255, 255));
        correo.setText("Correo");
        jPanel1.add(correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 80, 20));
        ...
        jPanel1.add(textcorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 290, 30));
        ...
        jPanel1.add(contra, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 120, 20));

        jSeparator3.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 290, 10));
        ...
        jPanel1.add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 290, 30));
        ...
        jPanel1.add(botonsesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 350, 120, 30));
        ...
        jPanel1.add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 390, 160, -1));

        nombre.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        nombre.setForeground(new java.awt.Color(255, 255, 255));
        nombre.setText("Nombre");
        jPanel1.add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 80, 20));

        textusua1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        textusua1.setForeground(new java.awt.Color(204, 204, 204));
        textusua1.setText("Ingrese su nombre");
        textusua1.setBorder(null);
        textusua1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel1.add(textusua1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 290, 30));

        jSeparator4.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 290, 10));
